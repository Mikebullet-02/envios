    ...
    >
        ...
        <div class="pb-6 col-span-full md:pb-0 md:col-span-6">
          ...
          >
            <img
              ...
              alt="Ómnibus de México"
            />
          </a>
        </div>
        <div class="col-span-6 mt-20 text-center md:text-center md:col-span-3">
          <ul>
            <li>
              <a
                rel="noopener noreferrer"
      ...
      <div class="grid justify-center pt-6 lg:justify-between">
        ...
        >
          ...
          <a
            rel="noopener noreferrer"
            href="https://odm.com.mx/aviso-privacidad"
          >
        ...
        <div class="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
          <a
            ...
            href="#"
            title="Facebook"
            class="flex items-center justify-center w-10 h-10 rounded-full dark:bg-dark dark:text-gray-900"
          >
            <svg
